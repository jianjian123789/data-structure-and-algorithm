...
tf.app.flags.DEFINE_string('checkpoints_dir', os.path.abspath('/home/wj/study/dlearn/05-second round/03-DL/01-NLP/01-tangyudi/tangshi/poem/src/inference/checkpoints/poems/'), 'checkpoints save path.')
# tf.app.flags.DEFINE_string('file_path', os.path.abspath('./dataset/data/poems.txt'), 'file name of poems.')
tf.app.flags.DEFINE_string('file_path', '/home/wj/study/dlearn/05-second round/03-DL/01-NLP/01-tangyudi/tangshi/poem/src/dataset/data/poems.txt', 'file name of poems.')
